  ...
  return (
    <View style={styles.container}>
      <View style={{flex:2, paddingTop:80}}>
            <Image source={require('../images/namaste2.png')} style={{height:300, width:300}}/>
        </View>
        <View style={{flex:1}}>
        ...
        <View style={{flex:1, justifyContent:'center',alignItems:'center'}}>
            <TouchableOpacity style={styles.btFrase} onPress={frasedoDia}>
                <Text style={{color:'#000', fontWeight:'bold'}}>A FRASE DO DIA É!</Text>
            </TouchableOpacity>
            ...
            <TouchableOpacity  style={[styles.theme]} onPress={ () => navigation.navigate('Home') }>
                <View>
                    <Text style={{fontWeight:'bold', color:'#000'}}> Light </Text>
                </View>
            </TouchableOpacity> 
