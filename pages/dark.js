...
import { StyleSheet, Text, View, StatusBar, TouchableOpacity, Image, Bu } from 'react-native';
...
const [img, setImg] = useState(require('../src/namaste2.png'));
  ...
  return (
    <View style={styles.container}>
     ...
     <TouchableOpacity  style={styles.botao} onPress={quebraBiscoto}>
       <View>
         <Text style={{fontWeight:'bold', color:'#000'}}> A FRASE DO DIA É!</Text>
       </View>
     </TouchableOpacity> 
     ...
     <TouchableOpacity  style={[styles.theme]} onPress={ () => navigation.navigate('LightPage') }>
       <View>
         <Text style={{fontWeight:'bold', color:'#000'}}> DARK </Text>
       </View>
     </TouchableOpacity>  
